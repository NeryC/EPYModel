    ...
    <>
      ...
      <Layout>
        <div className="flex flex-col p-6">
          {state.reported.data && <GraphComponent type2="reported2" title="Projection of possible new Infected/Daily reported" graphInfo={state.reported}/>}
          {/* <GraphComponent type2="reported2" title="Projection of daily hospitalized patients with unlimited bed capacity"/> */}
