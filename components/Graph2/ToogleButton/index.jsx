...
const ToogleButton = ({ label, name, handleChange, checkedState }) => {
  ...
  return(
    <div className="flex justify-between w-full mb-2">
      ...
      <input type="checkbox" checked={checkedState} name={name} id={name} 
        className="sr-only peer" readOnly/>
      <div className="w-11 h-6 bg-gray-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full 
        ...
        peer-checked:bg-indigo-600" onClick={()=>handleChange(name)}/>
      </label>
    </div>
  )
};
