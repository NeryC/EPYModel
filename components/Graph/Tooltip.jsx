...
export default function Tooltip ({data,tooltipRef}) {
  ...
  const chooseClass = (fieldName) => (fieldName == "Reportados" ? 'circle mx-auto' : 'dotted_line');
  ...
  return (
    <div className="relatvie border-2 w-fit rounded shadow-lg p-1 text-xsm" ref={tooltipRef}>  
